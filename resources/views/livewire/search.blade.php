    ...
    <form class="pt-2 mt-4 relative mx-auto text-gray-600" autocomplete="off">
        ...
        @if ($search)
            <ul class="absolute left-0 w-full bg-white rounded-lg mt-1 overflow-hidden">
                ...
                @empty
                    <li class="leading-10 px-5 flex flex-col justify-center items-center">
                        <img class="w-60" src="{{ asset('./img/ghost.gif') }}" alt="">
                        <p class="text-red-400 text-sm -mt-14 mb-12">Ningún resultado para la búsqueda...</p>
                    </li>
                @endforelse
            </ul>
        @endif
